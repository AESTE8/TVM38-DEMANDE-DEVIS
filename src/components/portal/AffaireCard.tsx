    ...
    >
      ...
      <div className="mt-5 flex flex-1 flex-col">
        <div className="flex items-start gap-3">
          <span className="mt-0.5 grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-primary/8 text-primary">
            <Package aria-hidden="true" className="h-5 w-5" />
          </span>
          <div className="min-w-0">
            <h2 className="font-headline text-base font-extrabold leading-snug text-on-surface">
              {materiaux.titre}
            </h2>
            <div className="mt-1.5 flex flex-wrap items-center gap-2 text-xs font-medium text-secondary">
              ...
              {materiaux.quantite && (
                <>
                  ...
                  <span className="font-bold text-on-surface-variant">{materiaux.quantite}</span>
                </>
              )}
            </div>
          </div>
        ...
        {affaire.lieu && (
          <p className="mt-4 flex items-start gap-2 text-sm leading-relaxed text-secondary">
            <MapPin aria-hidden="true" className="mt-0.5 h-4 w-4 shrink-0 text-primary/70" />
        ...
        <div className="mt-5 border-t border-border/55 pt-4">
          {affaire.montantHT !== null ? (
            <div className="flex items-end justify-between gap-4">
              <div className="min-w-0">
                <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-secondary/75">
                  Montant du devis
                </p>
                <p className="mt-1 font-headline text-2xl font-black tracking-tight text-on-surface">
              ...
              <div className="shrink-0 text-right">
                ...
                {affaire.pdfDisponible && (
                  <span className="mt-1.5 flex items-center justify-end gap-1 text-[11px] font-semibold text-emerald-700">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="text-xs font-bold text-primary">Suivre</span>
            </div>
          )}
        </div>
      </div>

      <div className="mt-4 flex items-center justify-end gap-2 text-xs font-bold text-primary">
        Voir le détail
        <ArrowRight
          aria-hidden="true"
